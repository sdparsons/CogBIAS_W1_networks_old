...
lh <- NCT(low3, high3, it=1000, gamma = .1, binary.data=FALSE)
lm <- NCT(low3, mid3, it=1000, gamma = .1, binary.data=FALSE)
mh <- NCT(mid3, high3, it=1000, gamma = .1, binary.data=FALSE)
